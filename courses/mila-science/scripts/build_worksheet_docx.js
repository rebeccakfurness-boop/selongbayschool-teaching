...
const doc1 = new Document({
  sections: [{
    ...
    children: [
      ...
      para("**3b.** Blood carries away waste, such as carbon dioxide. It needs to get rid of it because it's a waste gas the body doesn't need, and the lungs and kidneys are the organs that help get rid of it.", { shading: { type: ShadingType.CLEAR, fill: AMBER_LIGHT } }),
